...
preview: images/ENG_MACRO%201.png
twitter:
  site: "@unhcr"
  creator: "@unhcr"
...
meta() %>%
  meta_social(
    ...
    image = "https://raw.githubusercontent.com/unhcr-americas/ageingonthemove/main/images/ENG_MACRO%201.png",
...
```{r, layout="l-page"}
include_graphics("images/macro/ENG_MACRO_4.png")
```
...
```{r, layout="l-page"}
include_graphics("images/macro/ENG_MACRO_2.png")
```
...
<iframe width="1266" height="745" src="http://www.youtube.com/embed/Ehf67tMy-0c?rel=0" frameborder="0" allowfullscreen></iframe>
</div></div>
...
```{r, layout="l-page"}
include_graphics("images/macro/ENG_MACRO_1.png")
```
