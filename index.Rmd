---
title: "A claim to dignity: Ageing on the move"
description: |
...
meta() %>%
  meta_social(
    ...
    image_alt = "A claim to dignity: Ageing on the move",
    og_type = "website",
    og_author = "UNHCR",
...
<aside>A total of 865 older persons were consulted via telephone, as well as caretakers, service providers and key actors with in-depth and semi-structured interviews and online surveys. </aside>
...
With this report, [HelpAge](https://www.helpage.org/)  and [UNHCR](https://www.unhcr.org/americas.html) aim to cast light on the challenges and risks faced by older persons on the move so that actions are taken to ensure they are not left behind.
...
```{r, layout="l-body"}
include_graphics("images/info/eco1.png", dpi = NA)
```
...
With much of Latin America still in the throes of a devastating second wave of the virus, coronavirus stay-at-home restrictions have wiped out the one source of income the couple still had – Wilma’s sporadic work as a midwife, assisting local women with complicated deliveries. 

[...read the full story here!](https://www.unhcr.org/news/stories/2021/5/60ad7a004/covid-19-worsens-already-difficult-situation-older-refugees-latin-america.html)
...
<p class="tweetable">More than two thirds of older persons on the move had no activities to share or to socialize with others.</p>
...
<iframe width="560" height="415" src="https://www.youtube.com/embed/Ehf67tMy-0c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
